...
public class SAP_DAG {
    ...
    public int length(Iterable<Integer> v, Iterable<Integer> w) {
        ...
        int ancestor = SAP_DAG.bfs(G, v, w, visitedVertexLeft, visitedVertexRight);
    ...
    public int ancestor(Iterable<Integer> v, Iterable<Integer> w) {
        ...
        return SAP_DAG.bfs(G, v, w, visitedVertexLeft, visitedVertexRight);
    }
